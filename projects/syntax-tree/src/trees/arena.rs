...
//             },
//             None => {
//                 self.nodes.push(TextNode { link, data });
//                 self.nodes.len()
//             }
//         }
//     }
...
//         let new = self.create(
//             data,
//             NodeLink { parent: Some(parent), left: None, right: None, first_child: None, last_child: None },
//         );
...
//     }
//     pub fn get(&self, index: usize) -> &TextNode<T> {
